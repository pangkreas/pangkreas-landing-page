    ...
    <section className="bg-slate-900 py-24 text-white">
      <Container>
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 items-start">
          ...
          {/* Left content */}
          <div>
            <h2 className="mb-4 text-3xl font-bold">Why Pangkreas?</h2>
            <p className="mb-10 max-w-md text-slate-400">
              We work like product partners, not an outsourcing factory.
            </p>

            <ul className="space-y-6 text-slate-400">
              <li className="flex gap-4">
                <span className="mt-1 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-bold">
                  ✓
                </span>
                <p>
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-800 p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-4 transition-all duration-300 hover:-translate-y-1 hover:border-indigo-500/40">
                <span className="mb-1 block text-xs font-bold uppercase tracking-widest text-indigo-400">
                  Small Businesses
                </span>
                <p className="text-sm">
